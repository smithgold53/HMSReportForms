#ifndef PMSDEPARTMENTUSAGEINDETAIL108OLD_H
#define PMSDEPARTMENTUSAGEINDETAIL108OLD_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMSDepartmentUsageinDetail_108Old : public CGuiView{
protected:
	BOOL	m_bStockCheck;
	BOOL	m_bDeptCheck;
public:
	...
	void			OnExportSelect(); 
	CPMSDepartmentUsageinDetail_108Old(CWnd *pParent);
	~CPMSDepartmentUsageinDetail_108Old();
