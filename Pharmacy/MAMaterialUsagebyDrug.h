#ifndef MAMATERIALUSAGEBYDRUG_H
#define MAMATERIALUSAGEBYDRUG_H
...
#include "GuiView.h"
#include "DbField.h"
class CMAMaterialUsagebyDrug : public CGuiView{
protected:
	CString	m_szStorageStr;
	CString m_szObjectStr;
	CString m_szTypeStr;
	CString m_szDeptStr;
public:
	...
	void			OnStorageSelectChange(int nOldItem, int nNewItem); 
	...
	void			OnExportSelect(); 
	CMAMaterialUsagebyDrug(CWnd *pParent);
	~CMAMaterialUsagebyDrug();
