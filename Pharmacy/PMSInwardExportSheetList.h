#ifndef PMSINWARDEXPORTSHEETLIST_H
#define PMSINWARDEXPORTSHEETLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMSInwardExportSheetList : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CPMSInwardExportSheetList(CWnd *pParent);
	~CPMSInwardExportSheetList();
