#ifndef MAMATERIALUSAGEBYORIGINDEPT_H
#define MAMATERIALUSAGEBYORIGINDEPT_H
...
#include "GuiView.h"
#include "DbField.h"
class CMAMaterialUsagebyOriginDept : public CGuiView{
protected:
public:
	...
	CMAMaterialUsagebyOriginDept(CWnd *pParent);
	~CMAMaterialUsagebyOriginDept();
	...
	int OnStorageListCheckAll();
	int OnStorageListUncheckAll();
};
#endif
