#ifndef PMSPRESCRIPTIONLISTREPORTDIALOG_H
#define PMSPRESCRIPTIONLISTREPORTDIALOG_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMSPrescriptionListReportDialog : public CGuiView{
protected:
public:
	CGuiGroupBox	m_wndReportCondition;
	CGuiGroupBox	m_wndDeptType;
	CGuiGroupBox	m_wndItemType;
	...
	CGuiCheckBox	m_wndOrientalMedicine;
	CGuiCheckBox	m_wndOccidentMedicine;
	...
	void			OnObjectAddNew(); 
	CPMSPrescriptionListReportDialog(CWnd *pParent);
	~CPMSPrescriptionListReportDialog();
