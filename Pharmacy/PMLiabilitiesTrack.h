#ifndef PMLIABILITIESTRACK_H
#define PMLIABILITIESTRACK_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMLiabilitiesTrack : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CPMLiabilitiesTrack(CWnd *pParent);
	~CPMLiabilitiesTrack();
	...
	CString GetQueryString_Main();
	CString GetQueryString_FP();
	DECLARE_MESSAGE_MAP()
