#ifndef PMSOLDIERDRUGUSAGE_H
#define PMSOLDIERDRUGUSAGE_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMSoldierDrugUsage : public CGuiView{
protected:
public:
	...
	CGuiCheckBox	m_wndExamination;
	CGuiRadioButton	m_wndOutpatient;
	CGuiRadioButton m_wndInward;
	...
	CPMSoldierDrugUsage(CWnd *pParent);
	~CPMSoldierDrugUsage();
