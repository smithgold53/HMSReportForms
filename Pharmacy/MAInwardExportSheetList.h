#ifndef MAINWARDEXPORTSHEETLIST_H
#define MAINWARDEXPORTSHEETLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CMAInwardExportSheetList : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CMAInwardExportSheetList(CWnd *pParent);
	~CMAInwardExportSheetList();
