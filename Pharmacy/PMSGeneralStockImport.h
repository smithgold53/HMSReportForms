#ifndef PMSGENERALSTOCKIMPORT_H
#define PMSGENERALSTOCKIMPORT_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMSGeneralStockImport : public CGuiView{
protected:
public:
	...
	void			OnStdExport();
	void			OnCheckExport();
	CPMSGeneralStockImport(CWnd *pParent);
	~CPMSGeneralStockImport();
