#include "stdafx.h"
#include "PACSImageActivities.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CPACSImageActitivities *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CPACSImageActitivities *)pWnd)->OnToDateCheckValue();
} 
static void _OnGroupSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPACSImageActitivities* )pWnd)->OnGroupSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnGroupSelendokFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnGroupSelendok();
}
/*static void _OnGroupSetfocusFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnGroupKillfocus();
}*/
/*static void _OnGroupKillfocusFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnGroupKillfocus();
}*/
static long _OnGroupLoadDataFnc(CWnd *pWnd){
	return ((CPACSImageActitivities *)pWnd)->OnGroupLoadData();
}
/*static void _OnGroupAddNewFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnGroupAddNew();
}*/
static void _OnDeptSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPACSImageActitivities* )pWnd)->OnDeptSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDeptSelendokFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnDeptSelendok();
}
/*static void _OnDeptSetfocusFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnDeptKillfocus();
}*/
/*static void _OnDeptKillfocusFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnDeptKillfocus();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CPACSImageActitivities *)pWnd)->OnDeptLoadData();
}
/*static void _OnDeptAddNewFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnDeptAddNew();
}*/
static void _OnObjectSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPACSImageActitivities* )pWnd)->OnObjectSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnObjectSelendokFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnObjectSelendok();
}
/*static void _OnObjectSetfocusFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnObjectKillfocus();
}*/
/*static void _OnObjectKillfocusFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnObjectKillfocus();
}*/
static long _OnObjectLoadDataFnc(CWnd *pWnd){
	return ((CPACSImageActitivities *)pWnd)->OnObjectLoadData();
}
/*static void _OnObjectAddNewFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnObjectAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPACSImageActitivities* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CPACSImageActitivities *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CPACSImageActitivities *)pWnd)->OnStatusAddNew();
}*/
static void _OnByPerformDateSelectFnc(CWnd *pWnd){
	  ((CPACSImageActitivities*)pWnd)->OnByPerformDateSelect();
}
static void _OnByOrderDateSelectFnc(CWnd *pWnd){
	  ((CPACSImageActitivities*)pWnd)->OnByOrderDateSelect();
}
static void _OnPrintSelectFnc(CWnd *pWnd){
	CPACSImageActitivities *pVw = (CPACSImageActitivities *)pWnd;
	pVw->OnPrintSelect();
} 
...
CPACSImageActitivities::CPACSImageActitivities(CWnd *pParent){

	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
	SetDefaultValues();
}
CPACSImageActitivities::~CPACSImageActitivities(){
}
void CPACSImageActitivities::OnCreateComponents(){
...
void CPACSImageActitivities::OnInitializeComponents(){
...
void CPACSImageActitivities::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CPACSImageActitivities::OnDoDataExchange(CDataExchange* pDX){
...
void CPACSImageActitivities::SetDefaultValues(){
...
int CPACSImageActitivities::SetMode(int nMode){
...
/*void CPACSImageActitivities::OnFromDateChange(){
	
} */
/*void CPACSImageActitivities::OnFromDateSetfocus(){
	
} */
/*void CPACSImageActitivities::OnFromDateKillfocus(){
	
} */
int CPACSImageActitivities::OnFromDateCheckValue(){
	return 0;
} 
/*void CPACSImageActitivities::OnToDateChange(){
	
} */
/*void CPACSImageActitivities::OnToDateSetfocus(){
	
} */
/*void CPACSImageActitivities::OnToDateKillfocus(){
	
} */
int CPACSImageActitivities::OnToDateCheckValue(){
	return 0;
} 
void CPACSImageActitivities::OnGroupSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CPACSImageActitivities::OnGroupSelendok(){
	 
}
/*void CPACSImageActitivities::OnGroupSetfocus(){
	
}*/
/*void CPACSImageActitivities::OnGroupKillfocus(){
	
}*/
long CPACSImageActitivities::OnGroupLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CPACSImageActitivities::OnGroupAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CPACSImageActitivities::OnDeptSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CPACSImageActitivities::OnDeptSelendok(){
	 
}
/*void CPACSImageActitivities::OnDeptSetfocus(){
	
}*/
/*void CPACSImageActitivities::OnDeptKillfocus(){
	
}*/
long CPACSImageActitivities::OnDeptLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CPACSImageActitivities::OnDeptAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CPACSImageActitivities::OnObjectSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CPACSImageActitivities::OnObjectSelendok(){
	 
}
/*void CPACSImageActitivities::OnObjectSetfocus(){
	
}*/
/*void CPACSImageActitivities::OnObjectKillfocus(){
	
}*/
long CPACSImageActitivities::OnObjectLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CPACSImageActitivities::OnObjectAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CPACSImageActitivities::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CPACSImageActitivities::OnStatusSelendok(){
	 
}
/*void CPACSImageActitivities::OnStatusSetfocus(){
	
}*/
/*void CPACSImageActitivities::OnStatusKillfocus(){
	
}*/
long CPACSImageActitivities::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CPACSImageActitivities::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CPACSImageActitivities::OnByPerformDateSelect(){
	
}
void CPACSImageActitivities::OnByOrderDateSelect(){
	
}
void CPACSImageActitivities::OnPrintSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	/*Declaration Section*/
	CRecord rs(&pMF->m_db);
...
void CPACSImageActitivities::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	CExcel xls;
	...
	tmpStr = _T("HO\x1EA0T \x110\x1ED8NG H\xCCNH \x1EA2NH");
	...
	xls.Save(_T("Exports\\Hoat dong hinh anh.xls"));
} 

CString CPACSImageActitivities::GetQueryString(){
	CString szSQL, szWhere, tmpStr;
	if (m_nByPerformDate == 0)
		szWhere.AppendFormat(_T(" AND hpc_performdate BETWEEN cast_string2timestamp('%s') AND cast_string2timestamp('%s')") \
		_T(" AND hpc_status IN ('P', 'T')")
		, m_szFromDate, m_szToDate);
	else if (m_nByOrderDate == 0)
		szWhere.AppendFormat(_T(" AND hpc_orderdate BETWEEN cast_string2timestamp('%s') AND cast_string2timestamp('%s')")
		, m_szFromDate, m_szToDate);
	...
	szSQL.Format(_T(" SELECT    hpc_docno                            doc_no, ") \
				...
				_T(" LEFT JOIN hms_pacs_result ON (hpcl_docno = hpr_docno AND hpcl_orderid = hpr_orderid ") \
				_T(" AND hpcl_itemid = hpr_itemid AND hpr_name = 'Conclusion')") \
