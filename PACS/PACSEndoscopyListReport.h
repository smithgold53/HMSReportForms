#ifndef PACSENDOSCOPYLISTREPORT_H
#define PACSENDOSCOPYLISTREPORT_H
...
class CPACSEndoscopyListReport : public CGuiView{
protected:
public:
	...
	void			OnPolicySelect(); 
	CPACSEndoscopyListReport(CWnd* pParent);
	~CPACSEndoscopyListReport();
