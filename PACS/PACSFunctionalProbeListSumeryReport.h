#ifndef PACSFUNCTIONALPROBELISTSUMERYREPORT_H
#define PACSFUNCTIONALPROBELISTSUMERYREPORT_H
...
#include "GuiView.h"
#include "DbField.h"
class CPACSFunctionalProbeListSumeryReport : public CGuiView{
protected:
public:
	...
	CPACSFunctionalProbeListSumeryReport(CWnd* pParent);
	~CPACSFunctionalProbeListSumeryReport();
