#ifndef PACSIMAGEACTIVITIES_H
#define PACSIMAGEACTIVITIES_H
...
#include "GuiView.h"
#include "DbField.h"
class CPACSImageActitivities : public CGuiView{
protected:
...
public:
	...
	void			OnPrintSelect(); 
	void			OnExportSelect(); 
	CPACSImageActitivities(CWnd *pParent);
	~CPACSImageActitivities();
