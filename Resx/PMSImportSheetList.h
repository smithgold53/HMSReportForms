...
public:
	...
	CGuiCheckBox	m_wndInvoiceImport;
	CGuiCheckBox	m_wndNonInvoiceImport;
	...
	BOOL	m_bInvoiceImport;
	BOOL	m_bNonInvoiceImport;
	...
	void			OnInvoiceImportSelect(); 
	void			OnNonInvoiceImportSelect(); 
