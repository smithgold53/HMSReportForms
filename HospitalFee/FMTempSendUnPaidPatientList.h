#ifndef FMTEMPSENDUNPAIDPATIENTLIST_H
#define FMTEMPSENDUNPAIDPATIENTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMTempSendUnPaidPatientList : public CGuiView{
protected:
public:
	...
	CFMTempSendUnPaidPatientList(CWnd *pParent);
	~CFMTempSendUnPaidPatientList();
