#include "stdafx.h"
#include "FMDischargedUnpaidPatientListByDay.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMDischargedUnpaidPatientListByDay* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMDischargedUnpaidPatientListByDay* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientListByDay *)pWnd)->OnClerkAddNew();
}*/
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMDischargedUnpaidPatientListByDay *pVw = (CFMDischargedUnpaidPatientListByDay *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnObjectListLoadDataFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientListByDay*)pWnd)->OnObjectListLoadData();
} 
static void _OnObjectListDblClickFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientListByDay*)pWnd)->OnObjectListDblClick();
} 
static void _OnObjectListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMDischargedUnpaidPatientListByDay*)pWnd)->OnObjectListSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMDischargedUnpaidPatientListByDay*)pWnd)->OnObjectListDeleteItem();
} */
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientListByDay*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientListByDay*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMDischargedUnpaidPatientListByDay*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMDischargedUnpaidPatientListByDay*)pWnd)->OnDeptListDeleteItem();
} 
static int _OnAddFMDischargedUnpaidPatientListByDayFnc(CWnd *pWnd){
	 return ((CFMDischargedUnpaidPatientListByDay*)pWnd)->OnAddFMDischargedUnpaidPatientListByDay();
} 
static int _OnEditFMDischargedUnpaidPatientListByDayFnc(CWnd *pWnd){
	 return ((CFMDischargedUnpaidPatientListByDay*)pWnd)->OnEditFMDischargedUnpaidPatientListByDay();
} 
static int _OnDeleteFMDischargedUnpaidPatientListByDayFnc(CWnd *pWnd){
	 return ((CFMDischargedUnpaidPatientListByDay*)pWnd)->OnDeleteFMDischargedUnpaidPatientListByDay();
} 
static int _OnSaveFMDischargedUnpaidPatientListByDayFnc(CWnd *pWnd){
	 return ((CFMDischargedUnpaidPatientListByDay*)pWnd)->OnSaveFMDischargedUnpaidPatientListByDay();
} 
static int _OnCancelFMDischargedUnpaidPatientListByDayFnc(CWnd *pWnd){
	 return ((CFMDischargedUnpaidPatientListByDay*)pWnd)->OnCancelFMDischargedUnpaidPatientListByDay();
}
/*
static int _OnObjectListCheckAllFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientListByDay*)pWnd)->OnObjectListCheckAll();
}
static int _OnObjectListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientListByDay*)pWnd)->OnObjectListUnCheckAll();
}*/
static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientListByDay*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientListByDay*)pWnd)->OnDeptListUnCheckAll();
}

CFMDischargedUnpaidPatientListByDay::CFMDischargedUnpaidPatientListByDay(CWnd* pParent)
{
	m_nDlgWidth = 450;
	m_nDlgHeight = 555;
	SetDefaultValues();
}
CFMDischargedUnpaidPatientListByDay::~CFMDischargedUnpaidPatientListByDay(){
}
void CFMDischargedUnpaidPatientListByDay::OnCreateComponents()
{
...
void CFMDischargedUnpaidPatientListByDay::OnInitializeComponents()
{
...
void CFMDischargedUnpaidPatientListByDay::OnSetWindowEvents()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMDischargedUnpaidPatientListByDay::OnDoDataExchange(CDataExchange* pDX){
...
void CFMDischargedUnpaidPatientListByDay::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMDischargedUnpaidPatientListByDay::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMDischargedUnpaidPatientListByDay::SetDefaultValues(){
...
int CFMDischargedUnpaidPatientListByDay::SetMode(int nMode){
...
/*void CFMDischargedUnpaidPatientListByDay::OnYearChange(){
	
} */
/*void CFMDischargedUnpaidPatientListByDay::OnYearSetfocus(){
	
} */
/*void CFMDischargedUnpaidPatientListByDay::OnYearKillfocus(){
	
} */
int CFMDischargedUnpaidPatientListByDay::OnYearCheckValue()
{
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
...
void CFMDischargedUnpaidPatientListByDay::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMDischargedUnpaidPatientListByDay::OnReportPeriodSelendok()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMDischargedUnpaidPatientListByDay::OnReportPeriodSetfocus(){
	
}*/
/*void CFMDischargedUnpaidPatientListByDay::OnReportPeriodKillfocus(){
	
}*/
long CFMDischargedUnpaidPatientListByDay::OnReportPeriodLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMDischargedUnpaidPatientListByDay::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMDischargedUnpaidPatientListByDay::OnFromDateChange(){
	
} */
/*void CFMDischargedUnpaidPatientListByDay::OnFromDateSetfocus(){
	
} */
/*void CFMDischargedUnpaidPatientListByDay::OnFromDateKillfocus(){
	
} */
int CFMDischargedUnpaidPatientListByDay::OnFromDateCheckValue(){
	return 0;
} 
/*void CFMDischargedUnpaidPatientListByDay::OnToDateChange(){
	
} */
/*void CFMDischargedUnpaidPatientListByDay::OnToDateSetfocus(){
	
} */
/*void CFMDischargedUnpaidPatientListByDay::OnToDateKillfocus(){
	
} */
int CFMDischargedUnpaidPatientListByDay::OnToDateCheckValue(){
	return 0;
} 
void CFMDischargedUnpaidPatientListByDay::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMDischargedUnpaidPatientListByDay::OnClerkSelendok(){
	 
}
/*void CFMDischargedUnpaidPatientListByDay::OnClerkSetfocus(){
	
}*/
/*void CFMDischargedUnpaidPatientListByDay::OnClerkKillfocus(){
	
}*/
long CFMDischargedUnpaidPatientListByDay::OnClerkLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMDischargedUnpaidPatientListByDay::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMDischargedUnpaidPatientListByDay::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
...
void CFMDischargedUnpaidPatientListByDay::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
/*void CFMDischargedUnpaidPatientListByDay::OnObjectListDblClick(){
	
} 
void CFMDischargedUnpaidPatientListByDay::OnObjectListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMDischargedUnpaidPatientListByDay::OnObjectListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMDischargedUnpaidPatientListByDay::OnObjectListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMDischargedUnpaidPatientListByDay::OnDeptListDblClick(){
	
} 
void CFMDischargedUnpaidPatientListByDay::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMDischargedUnpaidPatientListByDay::OnDeptListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMDischargedUnpaidPatientListByDay::OnDeptListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
int CFMDischargedUnpaidPatientListByDay::OnAddFMDischargedUnpaidPatientListByDay(){
...
int CFMDischargedUnpaidPatientListByDay::OnEditFMDischargedUnpaidPatientListByDay(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMDischargedUnpaidPatientListByDay::OnDeleteFMDischargedUnpaidPatientListByDay(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMDischargedUnpaidPatientListByDay::OnSaveFMDischargedUnpaidPatientListByDay(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMDischargedUnpaidPatientListByDay::OnCancelFMDischargedUnpaidPatientListByDay(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMDischargedUnpaidPatientListByDay::OnDeptListCheckAll()
{
...
int CFMDischargedUnpaidPatientListByDay::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
...
/*int CFMDischargedUnpaidPatientListByDay::OnObjectListCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
...
int CFMDischargedUnpaidPatientListByDay::OnObjectListUnCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (m_wndObjectList.GetCheck(i))
...
CString CFMDischargedUnpaidPatientListByDay::GetQueryString(){
	...
	szSQL.Format(_T("SELECT    Get_patientname(docno) pname, docno,") \
				...
				_T("				   LEFT JOIN hms_fee_approve a ON ( a.hfe_docno = d.hfe_docno )") \
				_T("                   WHERE     1 = 1 ") \
				_T("                             AND hcr_status = 'T' AND d.hfe_status NOT IN ('C', 'R')  AND a.hfe_status = 'A' OR a.hfe_status IS NULL ") \
