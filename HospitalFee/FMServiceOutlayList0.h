...
public:
	...
	CGuiLabel		m_wndPaymentListLabel;
	CGuiComboBox	m_wndPaymentList;
	CGuiCheckBox	m_wndReportByPayment;
	...
	CString	m_szPaymentListKey;
	BOOL	m_bLocked;
	BOOL	m_bReportByPayment;
	//void			OnYearChange(); 
	//void			OnYearSetfocus(); 
