#include "stdafx.h"
#include "FMDepositUnpaidOutedPatientList.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMDepositUnpaidOutedPatientList *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMDepositUnpaidOutedPatientList *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMDepositUnpaidOutedPatientList *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMDepositUnpaidOutedPatientList *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMDepositUnpaidOutedPatientList* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMDepositUnpaidOutedPatientList *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMDepositUnpaidOutedPatientList *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMDepositUnpaidOutedPatientList *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMDepositUnpaidOutedPatientList *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMDepositUnpaidOutedPatientList *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMDepositUnpaidOutedPatientList *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMDepositUnpaidOutedPatientList *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMDepositUnpaidOutedPatientList *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMDepositUnpaidOutedPatientList *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMDepositUnpaidOutedPatientList *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMDepositUnpaidOutedPatientList *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMDepositUnpaidOutedPatientList *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMDepositUnpaidOutedPatientList *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMDepositUnpaidOutedPatientList* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMDepositUnpaidOutedPatientList *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMDepositUnpaidOutedPatientList *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMDepositUnpaidOutedPatientList *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMDepositUnpaidOutedPatientList *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMDepositUnpaidOutedPatientList *)pWnd)->OnClerkAddNew();
}*/
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMDepositUnpaidOutedPatientList *pVw = (CFMDepositUnpaidOutedPatientList *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnObjectListLoadDataFnc(CWnd *pWnd){
	return ((CFMDepositUnpaidOutedPatientList*)pWnd)->OnObjectListLoadData();
} 
static void _OnObjectListDblClickFnc(CWnd *pWnd){
	((CFMDepositUnpaidOutedPatientList*)pWnd)->OnObjectListDblClick();
} 
static void _OnObjectListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMDepositUnpaidOutedPatientList*)pWnd)->OnObjectListSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMDepositUnpaidOutedPatientList*)pWnd)->OnObjectListDeleteItem();
} */
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CFMDepositUnpaidOutedPatientList*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CFMDepositUnpaidOutedPatientList*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMDepositUnpaidOutedPatientList*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMDepositUnpaidOutedPatientList*)pWnd)->OnDeptListDeleteItem();
} 
static int _OnAddFMDepositUnpaidOutedPatientListFnc(CWnd *pWnd){
	 return ((CFMDepositUnpaidOutedPatientList*)pWnd)->OnAddFMDepositUnpaidOutedPatientList();
} 
static int _OnEditFMDepositUnpaidOutedPatientListFnc(CWnd *pWnd){
	 return ((CFMDepositUnpaidOutedPatientList*)pWnd)->OnEditFMDepositUnpaidOutedPatientList();
} 
static int _OnDeleteFMDepositUnpaidOutedPatientListFnc(CWnd *pWnd){
	 return ((CFMDepositUnpaidOutedPatientList*)pWnd)->OnDeleteFMDepositUnpaidOutedPatientList();
} 
static int _OnSaveFMDepositUnpaidOutedPatientListFnc(CWnd *pWnd){
	 return ((CFMDepositUnpaidOutedPatientList*)pWnd)->OnSaveFMDepositUnpaidOutedPatientList();
} 
static int _OnCancelFMDepositUnpaidOutedPatientListFnc(CWnd *pWnd){
	 return ((CFMDepositUnpaidOutedPatientList*)pWnd)->OnCancelFMDepositUnpaidOutedPatientList();
}
/*
static int _OnObjectListCheckAllFnc(CWnd *pWnd){
	return ((CFMDepositUnpaidOutedPatientList*)pWnd)->OnObjectListCheckAll();
}
static int _OnObjectListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMDepositUnpaidOutedPatientList*)pWnd)->OnObjectListUnCheckAll();
}*/
static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CFMDepositUnpaidOutedPatientList*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMDepositUnpaidOutedPatientList*)pWnd)->OnDeptListUnCheckAll();
}

CFMDepositUnpaidOutedPatientList::CFMDepositUnpaidOutedPatientList(CWnd* pParent)
{
	m_nDlgWidth = 450;
	m_nDlgHeight = 555;
	SetDefaultValues();
}
CFMDepositUnpaidOutedPatientList::~CFMDepositUnpaidOutedPatientList(){
}
void CFMDepositUnpaidOutedPatientList::OnCreateComponents()
{
...
void CFMDepositUnpaidOutedPatientList::OnInitializeComponents()
{
...
void CFMDepositUnpaidOutedPatientList::OnSetWindowEvents()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMDepositUnpaidOutedPatientList::OnDoDataExchange(CDataExchange* pDX){
...
void CFMDepositUnpaidOutedPatientList::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMDepositUnpaidOutedPatientList::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMDepositUnpaidOutedPatientList::SetDefaultValues(){
...
int CFMDepositUnpaidOutedPatientList::SetMode(int nMode){
...
/*void CFMDepositUnpaidOutedPatientList::OnYearChange(){
	
} */
/*void CFMDepositUnpaidOutedPatientList::OnYearSetfocus(){
	
} */
/*void CFMDepositUnpaidOutedPatientList::OnYearKillfocus(){
	
} */
int CFMDepositUnpaidOutedPatientList::OnYearCheckValue()
{
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
...
void CFMDepositUnpaidOutedPatientList::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMDepositUnpaidOutedPatientList::OnReportPeriodSelendok()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMDepositUnpaidOutedPatientList::OnReportPeriodSetfocus(){
	
}*/
/*void CFMDepositUnpaidOutedPatientList::OnReportPeriodKillfocus(){
	
}*/
long CFMDepositUnpaidOutedPatientList::OnReportPeriodLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMDepositUnpaidOutedPatientList::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMDepositUnpaidOutedPatientList::OnFromDateChange(){
	
} */
/*void CFMDepositUnpaidOutedPatientList::OnFromDateSetfocus(){
	
} */
/*void CFMDepositUnpaidOutedPatientList::OnFromDateKillfocus(){
	
} */
int CFMDepositUnpaidOutedPatientList::OnFromDateCheckValue(){
	return 0;
} 
/*void CFMDepositUnpaidOutedPatientList::OnToDateChange(){
	
} */
/*void CFMDepositUnpaidOutedPatientList::OnToDateSetfocus(){
	
} */
/*void CFMDepositUnpaidOutedPatientList::OnToDateKillfocus(){
	
} */
int CFMDepositUnpaidOutedPatientList::OnToDateCheckValue(){
	return 0;
} 
void CFMDepositUnpaidOutedPatientList::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMDepositUnpaidOutedPatientList::OnClerkSelendok(){
	 
}
/*void CFMDepositUnpaidOutedPatientList::OnClerkSetfocus(){
	
}*/
/*void CFMDepositUnpaidOutedPatientList::OnClerkKillfocus(){
	
}*/
long CFMDepositUnpaidOutedPatientList::OnClerkLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMDepositUnpaidOutedPatientList::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMDepositUnpaidOutedPatientList::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
...
void CFMDepositUnpaidOutedPatientList::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
/*void CFMDepositUnpaidOutedPatientList::OnObjectListDblClick(){
	
} 
void CFMDepositUnpaidOutedPatientList::OnObjectListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMDepositUnpaidOutedPatientList::OnObjectListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMDepositUnpaidOutedPatientList::OnObjectListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMDepositUnpaidOutedPatientList::OnDeptListDblClick(){
	
} 
void CFMDepositUnpaidOutedPatientList::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMDepositUnpaidOutedPatientList::OnDeptListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMDepositUnpaidOutedPatientList::OnDeptListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
int CFMDepositUnpaidOutedPatientList::OnAddFMDepositUnpaidOutedPatientList(){
...
int CFMDepositUnpaidOutedPatientList::OnEditFMDepositUnpaidOutedPatientList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMDepositUnpaidOutedPatientList::OnDeleteFMDepositUnpaidOutedPatientList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelFMDepositUnpaidOutedPatientList();
 	}
	return 0;
}
int CFMDepositUnpaidOutedPatientList::OnSaveFMDepositUnpaidOutedPatientList(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
 ...
 _fmsg(_T("%s"), szSQL);
 	...
 	if(ret > 0)
 	{
 		//OnFMDepositUnpaidOutedPatientListListLoadData();
 		SetMode(VM_VIEW);
 	}
 	else
 	{
...
int CFMDepositUnpaidOutedPatientList::OnCancelFMDepositUnpaidOutedPatientList(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMDepositUnpaidOutedPatientList::OnDeptListCheckAll()
{
...
int CFMDepositUnpaidOutedPatientList::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
...
/*int CFMDepositUnpaidOutedPatientList::OnObjectListCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
...
int CFMDepositUnpaidOutedPatientList::OnObjectListUnCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (m_wndObjectList.GetCheck(i))
...
CString CFMDepositUnpaidOutedPatientList::GetQueryString(){
	...
	szSQL.Format(_T("SELECT    Get_patientname(docno) pname, ") \
					_T("          deptid, ") \
					_T("          recordno, docno, ngayvao, ngayra, ") \
					_T("          deposit, ") \
					_T("          feeamt, ") \
