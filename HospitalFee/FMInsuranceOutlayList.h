#ifndef FMINSURANCEOUTLAYLIST_H
#define FMINSURANCEOUTLAYLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMInsuranceOutlayList : public CGuiView{
protected:
public:
	...
	int			OnListLoadData();
	void			OnLockedSelect(); 
	CFMInsuranceOutlayList(CWnd *pParent);
	~CFMInsuranceOutlayList();
