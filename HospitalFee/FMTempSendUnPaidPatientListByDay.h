#ifndef FMTEMPSENDUNPAIDPATIENTLISTBYDAY_H
#define FMTEMPSENDUNPAIDPATIENTLISTBYDAY_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMTempSendUnPaidPatientListByDay : public CGuiView{
protected:
public:
	...
	CFMTempSendUnPaidPatientListByDay(CWnd *pParent);
	~CFMTempSendUnPaidPatientListByDay();
