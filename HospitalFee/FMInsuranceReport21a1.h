#ifndef FMINSURANCEREPORT21A1_H
#define FMINSURANCEREPORT21A1_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMInsuranceReport21a1 : public CGuiView{
protected:
...
public:
	...
	CFMInsuranceReport21a1(CWnd *pParent);
	~CFMInsuranceReport21a1();
	...
	CString GetQueryString_DtlbyPatient();
};
#endif
