#include "stdafx.h"
#include "FMTempSendUnPaidPatientListByDay.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMTempSendUnPaidPatientListByDay* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnToDateCheckValue();
} 
static void _OnStaffSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMTempSendUnPaidPatientListByDay* )pWnd)->OnStaffSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStaffSelendokFnc(CWnd *pWnd){
	((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnStaffSelendok();
}
/*static void _OnStaffSetfocusFnc(CWnd *pWnd){
	((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnStaffKillfocus();
}*/
/*static void _OnStaffKillfocusFnc(CWnd *pWnd){
	((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnStaffKillfocus();
}*/
static long _OnStaffLoadDataFnc(CWnd *pWnd){
	return ((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnStaffLoadData();
}
/*static void _OnStaffAddNewFnc(CWnd *pWnd){
	((CFMTempSendUnPaidPatientListByDay *)pWnd)->OnStaffAddNew();
}*/
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMTempSendUnPaidPatientListByDay *pVw = (CFMTempSendUnPaidPatientListByDay *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CFMTempSendUnPaidPatientListByDay*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CFMTempSendUnPaidPatientListByDay*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMTempSendUnPaidPatientListByDay*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMTempSendUnPaidPatientListByDay*)pWnd)->OnDeptListDeleteItem();
} 
static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CFMTempSendUnPaidPatientListByDay*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMTempSendUnPaidPatientListByDay*)pWnd)->OnDeptListUnCheckAll();
}
CFMTempSendUnPaidPatientListByDay::CFMTempSendUnPaidPatientListByDay(CWnd *pParent){

	m_nDlgWidth = 585;
	m_nDlgHeight = 585;
	SetDefaultValues();
}
CFMTempSendUnPaidPatientListByDay::~CFMTempSendUnPaidPatientListByDay(){
}
void CFMTempSendUnPaidPatientListByDay::OnCreateComponents(){
...
void CFMTempSendUnPaidPatientListByDay::OnInitializeComponents(){
...
void CFMTempSendUnPaidPatientListByDay::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMTempSendUnPaidPatientListByDay::OnDoDataExchange(CDataExchange* pDX){
...
void CFMTempSendUnPaidPatientListByDay::SetDefaultValues(){
...
int CFMTempSendUnPaidPatientListByDay::SetMode(int nMode){
...
/*void CFMTempSendUnPaidPatientListByDay::OnYearChange(){
	
} */
/*void CFMTempSendUnPaidPatientListByDay::OnYearSetfocus(){
	
} */
/*void CFMTempSendUnPaidPatientListByDay::OnYearKillfocus(){
	
} */
int CFMTempSendUnPaidPatientListByDay::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMTempSendUnPaidPatientListByDay::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMTempSendUnPaidPatientListByDay::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMTempSendUnPaidPatientListByDay::OnReportPeriodSetfocus(){
	
}*/
/*void CFMTempSendUnPaidPatientListByDay::OnReportPeriodKillfocus(){
	
}*/
long CFMTempSendUnPaidPatientListByDay::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMTempSendUnPaidPatientListByDay::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMTempSendUnPaidPatientListByDay::OnFromDateChange(){
	
} */
/*void CFMTempSendUnPaidPatientListByDay::OnFromDateSetfocus(){
	
} */
/*void CFMTempSendUnPaidPatientListByDay::OnFromDateKillfocus(){
	
} */
int CFMTempSendUnPaidPatientListByDay::OnFromDateCheckValue(){
	return 0;
}
 
/*void CFMTempSendUnPaidPatientListByDay::OnToDateChange(){
	
} */
/*void CFMTempSendUnPaidPatientListByDay::OnToDateSetfocus(){
	
} */
/*void CFMTempSendUnPaidPatientListByDay::OnToDateKillfocus(){
	
} */
int CFMTempSendUnPaidPatientListByDay::OnToDateCheckValue(){
	return 0;
}
void CFMTempSendUnPaidPatientListByDay::OnStaffSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMTempSendUnPaidPatientListByDay::OnStaffSelendok(){
	 
}
/*void CFMTempSendUnPaidPatientListByDay::OnStaffSetfocus(){
	
}*/
/*void CFMTempSendUnPaidPatientListByDay::OnStaffKillfocus(){
	
}*/
long CFMTempSendUnPaidPatientListByDay::OnStaffLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMTempSendUnPaidPatientListByDay::OnStaffAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CFMTempSendUnPaidPatientListByDay::OnPrintSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	...
	if (!rpt.Init(_T("Reports/HMS/HF_DANHSACHBENHNHANTAMGUI_1CHUATT.RPT")))
		return;
...
void CFMTempSendUnPaidPatientListByDay::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\DSBNTamGuiChuaThanhToan(theongay).xls"));
}

void CFMTempSendUnPaidPatientListByDay::OnDeptListDblClick(){
	
}
 
void CFMTempSendUnPaidPatientListByDay::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMTempSendUnPaidPatientListByDay::OnDeptListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMTempSendUnPaidPatientListByDay::OnDeptListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
CString CFMTempSendUnPaidPatientListByDay::GetQueryString(){
	...
	szSQL.Format(_T(" SELECT    Get_patientname(hfe_docno)     pname, ") \
				...
				_T("       AND hfe_status = 'P' AND hfe_objectid = '7'  AND fac_posted = 'Y' AND hcrf_acceptedfee <> 'P'") \
				_T(" ORDER     BY fac_posteddate "), m_szFromDate, m_szToDate, szWhere);

	return szSQL;
}

int CFMTempSendUnPaidPatientListByDay::OnDeptListCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (!m_wndDeptList.GetCheck(i))
...
int CFMTempSendUnPaidPatientListByDay::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
