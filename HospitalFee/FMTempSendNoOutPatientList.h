#ifndef FMTEMPSENDNOOUTPATIENTLIST_H
#define FMTEMPSENDNOOUTPATIENTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMTempSendNoOutPatientList : public CGuiView{
protected:
public:
	...
	CFMTempSendNoOutPatientList(CWnd *pParent);
	~CFMTempSendNoOutPatientList();
