#ifndef FMFOODSUMMARYBYLEVEL_H
#define FMFOODSUMMARYBYLEVEL_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMFoodSummaryByLevel : public CGuiView{
protected:
public:
	...
	CFMFoodSummaryByLevel(CWnd *pParent);
	~CFMFoodSummaryByLevel();
