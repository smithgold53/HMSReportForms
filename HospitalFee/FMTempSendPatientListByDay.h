#ifndef FMTEMPSENDPATIENTLISTBYDAY_H
#define FMTEMPSENDPATIENTLISTBYDAY_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMTempSendPatientListByDay : public CGuiView{
protected:
public:
	...
	CFMTempSendPatientListByDay(CWnd *pParent);
	~CFMTempSendPatientListByDay();
