#ifndef FMTEMPSENDPATIENTLIST_H
#define FMTEMPSENDPATIENTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMTempSendPatientList : public CGuiView{
protected:
public:
	...
	CFMTempSendPatientList(CWnd *pParent);
	~CFMTempSendPatientList();
