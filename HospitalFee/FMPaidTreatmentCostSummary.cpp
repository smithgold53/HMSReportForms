#include "stdafx.h"
#include "FMPaidTreatmentCostSummary.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMPaidTreatmentCostSummary *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMPaidTreatmentCostSummary *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMPaidTreatmentCostSummary *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMPaidTreatmentCostSummary *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPaidTreatmentCostSummary* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMPaidTreatmentCostSummary *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMPaidTreatmentCostSummary *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMPaidTreatmentCostSummary *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMPaidTreatmentCostSummary *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMPaidTreatmentCostSummary *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMPaidTreatmentCostSummary *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMPaidTreatmentCostSummary *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMPaidTreatmentCostSummary *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMPaidTreatmentCostSummary *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMPaidTreatmentCostSummary *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMPaidTreatmentCostSummary *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMPaidTreatmentCostSummary *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMPaidTreatmentCostSummary *)pWnd)->OnToDateCheckValue();
} 
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMPaidTreatmentCostSummary *pVw = (CFMPaidTreatmentCostSummary *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnObjectListLoadDataFnc(CWnd *pWnd){
	return ((CFMPaidTreatmentCostSummary*)pWnd)->OnObjectListLoadData();
} 
static void _OnObjectListDblClickFnc(CWnd *pWnd){
	((CFMPaidTreatmentCostSummary*)pWnd)->OnObjectListDblClick();
} 
static void _OnObjectListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMPaidTreatmentCostSummary*)pWnd)->OnObjectListSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMPaidTreatmentCostSummary*)pWnd)->OnObjectListDeleteItem();
} 
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CFMPaidTreatmentCostSummary*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CFMPaidTreatmentCostSummary*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMPaidTreatmentCostSummary*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMPaidTreatmentCostSummary*)pWnd)->OnDeptListDeleteItem();
} 
static int _OnObjectListCheckAllFnc(CWnd *pWnd){
	return ((CFMPaidTreatmentCostSummary*)pWnd)->OnObjectListCheckAll();
}
static int _OnObjectListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMPaidTreatmentCostSummary*)pWnd)->OnObjectListUnCheckAll();
}
static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CFMPaidTreatmentCostSummary*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMPaidTreatmentCostSummary*)pWnd)->OnDeptListUnCheckAll();
}
CFMPaidTreatmentCostSummary::CFMPaidTreatmentCostSummary(CWnd *pParent){

	m_nDlgWidth = 585;
	m_nDlgHeight = 585;
	SetDefaultValues();
}
CFMPaidTreatmentCostSummary::~CFMPaidTreatmentCostSummary(){
}
void CFMPaidTreatmentCostSummary::OnCreateComponents(){
...
void CFMPaidTreatmentCostSummary::OnInitializeComponents(){
...
void CFMPaidTreatmentCostSummary::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMPaidTreatmentCostSummary::OnDoDataExchange(CDataExchange* pDX){
...
void CFMPaidTreatmentCostSummary::SetDefaultValues(){
...
int CFMPaidTreatmentCostSummary::SetMode(int nMode){
...
/*void CFMPaidTreatmentCostSummary::OnYearChange(){
	
} */
/*void CFMPaidTreatmentCostSummary::OnYearSetfocus(){
	
} */
/*void CFMPaidTreatmentCostSummary::OnYearKillfocus(){
	
} */
int CFMPaidTreatmentCostSummary::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMPaidTreatmentCostSummary::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMPaidTreatmentCostSummary::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMPaidTreatmentCostSummary::OnReportPeriodSetfocus(){
	
}*/
/*void CFMPaidTreatmentCostSummary::OnReportPeriodKillfocus(){
	
}*/
long CFMPaidTreatmentCostSummary::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMPaidTreatmentCostSummary::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMPaidTreatmentCostSummary::OnFromDateChange(){
	
} */
/*void CFMPaidTreatmentCostSummary::OnFromDateSetfocus(){
	
} */
/*void CFMPaidTreatmentCostSummary::OnFromDateKillfocus(){
	
} */
int CFMPaidTreatmentCostSummary::OnFromDateCheckValue(){
	return 0;
}
 
/*void CFMPaidTreatmentCostSummary::OnToDateChange(){
	
} */
/*void CFMPaidTreatmentCostSummary::OnToDateSetfocus(){
	
} */
/*void CFMPaidTreatmentCostSummary::OnToDateKillfocus(){
	
} */
int CFMPaidTreatmentCostSummary::OnToDateCheckValue(){
	return 0;
}
 
void CFMPaidTreatmentCostSummary::OnPrintSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMPaidTreatmentCostSummary::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMPaidTreatmentCostSummary::OnObjectListDblClick(){
	
}
 
void CFMPaidTreatmentCostSummary::OnObjectListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMPaidTreatmentCostSummary::OnObjectListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMPaidTreatmentCostSummary::OnObjectListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString szWhere;
...
void CFMPaidTreatmentCostSummary::OnDeptListDblClick(){
	
}
 
void CFMPaidTreatmentCostSummary::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMPaidTreatmentCostSummary::OnDeptListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMPaidTreatmentCostSummary::OnDeptListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
CString CFMPaidTreatmentCostSummary::GetQueryString(){
	...
	szSQL.Format(_T(" SELECT    Get_patientname(a.hfe_docno)     pname, ") \
				_T("           Get_departmentname(a.hfe_deptid) dept, ") \
				_T("           hcr_recordno                     recordno, ") \
				_T("           a.hfe_date                       receiptdate, ") \
				_T("           a.hfe_amount                     deposit ") \
				_T(" FROM      hms_fee_deposit a ") \
				_T(" LEFT JOIN hms_clinical_record ON ( hcr_docno = a.hfe_docno ) ") \
				_T(" LEFT JOIN hms_fee_invoice i ON ( i.hfe_invoiceno = a.hfe_refidx ) ") \
				_T(" WHERE     a.hfe_date BETWEEN Cast_string2timestamp('%s') AND Cast_string2timestamp('%s') %s ") \
				_T("       AND a.hfe_status = 'P' ") \
				_T("       AND Coalesce(i.hfe_status, 'N') <> 'P' ") \
				_T(" ORDER     BY a.hfe_deptid "), m_szFromDate, m_szToDate, szWhere);
	return szSQL;
}

int CFMPaidTreatmentCostSummary::OnDeptListCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (!m_wndDeptList.GetCheck(i))
...
int CFMPaidTreatmentCostSummary::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
...
int CFMPaidTreatmentCostSummary::OnObjectListCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (!m_wndObjectList.GetCheck(i))
...
int CFMPaidTreatmentCostSummary::OnObjectListUnCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (m_wndObjectList.GetCheck(i))
