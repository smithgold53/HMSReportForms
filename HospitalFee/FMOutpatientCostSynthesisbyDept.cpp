#include "stdafx.h"
#include "FMOutpatientCostSynthesisbyDept.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMOutpatientCostSynthesisbyDept *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMOutpatientCostSynthesisbyDept *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMOutpatientCostSynthesisbyDept *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMOutpatientCostSynthesisbyDept *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMOutpatientCostSynthesisbyDept* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMOutpatientCostSynthesisbyDept *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMOutpatientCostSynthesisbyDept *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMOutpatientCostSynthesisbyDept *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMOutpatientCostSynthesisbyDept *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMOutpatientCostSynthesisbyDept *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMOutpatientCostSynthesisbyDept *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMOutpatientCostSynthesisbyDept *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMOutpatientCostSynthesisbyDept *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMOutpatientCostSynthesisbyDept *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMOutpatientCostSynthesisbyDept *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMOutpatientCostSynthesisbyDept *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMOutpatientCostSynthesisbyDept *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMOutpatientCostSynthesisbyDept *)pWnd)->OnToDateCheckValue();
} 
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CFMOutpatientCostSynthesisbyDept *pVw = (CFMOutpatientCostSynthesisbyDept *)pWnd;
...
static int _OnAddFMOutpatientCostSynthesisbyDeptFnc(CWnd *pWnd){
	 return ((CFMOutpatientCostSynthesisbyDept*)pWnd)->OnAddFMOutpatientCostSynthesisbyDept();
} 
static int _OnEditFMOutpatientCostSynthesisbyDeptFnc(CWnd *pWnd){
	 return ((CFMOutpatientCostSynthesisbyDept*)pWnd)->OnEditFMOutpatientCostSynthesisbyDept();
} 
static int _OnDeleteFMOutpatientCostSynthesisbyDeptFnc(CWnd *pWnd){
	 return ((CFMOutpatientCostSynthesisbyDept*)pWnd)->OnDeleteFMOutpatientCostSynthesisbyDept();
} 
static int _OnSaveFMOutpatientCostSynthesisbyDeptFnc(CWnd *pWnd){
	 return ((CFMOutpatientCostSynthesisbyDept*)pWnd)->OnSaveFMOutpatientCostSynthesisbyDept();
} 
static int _OnCancelFMOutpatientCostSynthesisbyDeptFnc(CWnd *pWnd){
	 return ((CFMOutpatientCostSynthesisbyDept*)pWnd)->OnCancelFMOutpatientCostSynthesisbyDept();
} 
CFMOutpatientCostSynthesisbyDept::CFMOutpatientCostSynthesisbyDept(CWnd *pParent){

	m_nDlgWidth = 440;
	m_nDlgHeight = 130;
	SetDefaultValues();
}
CFMOutpatientCostSynthesisbyDept::~CFMOutpatientCostSynthesisbyDept(){
}
void CFMOutpatientCostSynthesisbyDept::OnCreateComponents(){
...
void CFMOutpatientCostSynthesisbyDept::OnInitializeComponents()
{
...
void CFMOutpatientCostSynthesisbyDept::OnSetWindowEvents(){
	...
	//AddEvent(1, _T("Add	Ctrl+A"), _OnAddFMOutpatientCostSynthesisbyDeptFnc, 0, 'A', VK_CONTROL);
	//AddEvent(2, _T("Edit	Ctrl+E"), _OnEditFMOutpatientCostSynthesisbyDeptFnc, 0, 'E', VK_CONTROL);
	//AddEvent(3, _T("Delete	Ctrl+D"), _OnDeleteFMOutpatientCostSynthesisbyDeptFnc, 0, 'D', VK_CONTROL);
	//AddEvent(4, _T("Save	Ctrl+S"), _OnSaveFMOutpatientCostSynthesisbyDeptFnc, 0, 'S', VK_CONTROL);
	//AddEvent(0, _T("-"));
	//AddEvent(5, _T("Cancel	Ctrl+T"), _OnCancelFMOutpatientCostSynthesisbyDeptFnc, 0, 'T', VK_CONTROL);
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMOutpatientCostSynthesisbyDept::OnDoDataExchange(CDataExchange* pDX){
...
void CFMOutpatientCostSynthesisbyDept::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMOutpatientCostSynthesisbyDept::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMOutpatientCostSynthesisbyDept::SetDefaultValues(){
...
int CFMOutpatientCostSynthesisbyDept::SetMode(int nMode){
...
/*void CFMOutpatientCostSynthesisbyDept::OnYearChange(){
	
} */
/*void CFMOutpatientCostSynthesisbyDept::OnYearSetfocus(){
	
} */
/*void CFMOutpatientCostSynthesisbyDept::OnYearKillfocus(){
	
} */
int CFMOutpatientCostSynthesisbyDept::OnYearCheckValue()
{
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
...
void CFMOutpatientCostSynthesisbyDept::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMOutpatientCostSynthesisbyDept::OnReportPeriodSelendok()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMOutpatientCostSynthesisbyDept::OnReportPeriodSetfocus(){
	
}*/
/*void CFMOutpatientCostSynthesisbyDept::OnReportPeriodKillfocus(){
	
}*/
long CFMOutpatientCostSynthesisbyDept::OnReportPeriodLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMOutpatientCostSynthesisbyDept::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMOutpatientCostSynthesisbyDept::OnFromDateChange(){
	
} */
/*void CFMOutpatientCostSynthesisbyDept::OnFromDateSetfocus(){
	
} */
/*void CFMOutpatientCostSynthesisbyDept::OnFromDateKillfocus(){
	
} */
int CFMOutpatientCostSynthesisbyDept::OnFromDateCheckValue(){
	return 0;
} 
/*void CFMOutpatientCostSynthesisbyDept::OnToDateChange(){
	
} */
/*void CFMOutpatientCostSynthesisbyDept::OnToDateSetfocus(){
	
} */
/*void CFMOutpatientCostSynthesisbyDept::OnToDateKillfocus(){
	
} */
int CFMOutpatientCostSynthesisbyDept::OnToDateCheckValue(){
	return 0;
} 
void CFMOutpatientCostSynthesisbyDept::OnPrintPreviewSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMOutpatientCostSynthesisbyDept::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\Tong Hop Chi Phi KCB Ngoai Tru theo Khoa.xls"));
} 
int CFMOutpatientCostSynthesisbyDept::OnAddFMOutpatientCostSynthesisbyDept(){
...
int CFMOutpatientCostSynthesisbyDept::OnEditFMOutpatientCostSynthesisbyDept(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CFMOutpatientCostSynthesisbyDept::OnDeleteFMOutpatientCostSynthesisbyDept(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
 	...
 	if(ret >= 0){ 
 		SetMode(VM_NONE); 
 		OnCancelFMOutpatientCostSynthesisbyDept(); 
 	}
	return 0;
}
int CFMOutpatientCostSynthesisbyDept::OnSaveFMOutpatientCostSynthesisbyDept(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
 ...
 _fmsg(_T("%s"), szSQL); 
 	...
 	if(ret > 0) 
 	{ 
 		//OnFMOutpatientCostSynthesisbyDeptListLoadData(); 
 		SetMode(VM_VIEW); 
 	} 
 	else 
 	{ 
...
int CFMOutpatientCostSynthesisbyDept::OnCancelFMOutpatientCostSynthesisbyDept(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CFMOutpatientCostSynthesisbyDept::OnFMOutpatientCostSynthesisbyDeptListLoadData(){
	return 0;
}
CString CFMOutpatientCostSynthesisbyDept::GetQueryString()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
	CString szSQL, szWhere;
	szWhere.Empty();
	...
	szSQL.Format(_T(" SELECT (select distinct sd_name from sys_dept where sd_id=dept) as c1,") \
				...
				_T("   WHERE fi.hfe_date BETWEEN cast_string2timestamp('%s') and cast_string2timestamp('%s')") \
				_T("         AND fe.hfe_inspaid > 0 AND fi.hfe_class in('E') %s") \
				_T("  ) feetbl2") \
