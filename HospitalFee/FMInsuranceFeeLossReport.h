#ifndef FMINSURANCEFEELOSSREPORT_H
#define FMINSURANCEFEELOSSREPORT_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMInsuranceFeeLossReport : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect(); 
	void			OnExportSelect(); 
	CFMInsuranceFeeLossReport(CWnd* pParent);
	~CFMInsuranceFeeLossReport();
