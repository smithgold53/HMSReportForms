#include "stdafx.h"
#include "FMDischargedPaidPatientListByDay.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMDischargedPaidPatientListByDay *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMDischargedPaidPatientListByDay* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMDischargedPaidPatientListByDay *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMDischargedPaidPatientListByDay *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMDischargedPaidPatientListByDay *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMDischargedPaidPatientListByDay* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMDischargedPaidPatientListByDay *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay *)pWnd)->OnClerkAddNew();
}*/
static void _OnStaffSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMDischargedPaidPatientListByDay* )pWnd)->OnStaffSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStaffSelendokFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay *)pWnd)->OnStaffSelendok();
}
/*static void _OnStaffSetfocusFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay *)pWnd)->OnStaffKillfocus();
}*/
/*static void _OnStaffKillfocusFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay *)pWnd)->OnStaffKillfocus();
}*/
static long _OnStaffLoadDataFnc(CWnd *pWnd){
	return ((CFMDischargedPaidPatientListByDay *)pWnd)->OnStaffLoadData();
}
/*static void _OnStaffAddNewFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientList *)pWnd)->OnStaffAddNew();
}*/
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMDischargedPaidPatientListByDay *pVw = (CFMDischargedPaidPatientListByDay *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnObjectListLoadDataFnc(CWnd *pWnd){
	return ((CFMDischargedPaidPatientListByDay*)pWnd)->OnObjectListLoadData();
} 
static void _OnObjectListDblClickFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay*)pWnd)->OnObjectListDblClick();
} 
static void _OnObjectListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMDischargedPaidPatientListByDay*)pWnd)->OnObjectListSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMDischargedPaidPatientListByDay*)pWnd)->OnObjectListDeleteItem();
} */
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CFMDischargedPaidPatientListByDay*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CFMDischargedPaidPatientListByDay*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMDischargedPaidPatientListByDay*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMDischargedPaidPatientListByDay*)pWnd)->OnDeptListDeleteItem();
} 
static int _OnAddFMDischargedPaidPatientListByDayFnc(CWnd *pWnd){
	 return ((CFMDischargedPaidPatientListByDay*)pWnd)->OnAddFMDischargedPaidPatientListByDay();
} 
static int _OnEditFMDischargedPaidPatientListByDayFnc(CWnd *pWnd){
	 return ((CFMDischargedPaidPatientListByDay*)pWnd)->OnEditFMDischargedPaidPatientListByDay();
} 
static int _OnDeleteFMDischargedPaidPatientListByDayFnc(CWnd *pWnd){
	 return ((CFMDischargedPaidPatientListByDay*)pWnd)->OnDeleteFMDischargedPaidPatientListByDay();
} 
static int _OnSaveFMDischargedPaidPatientListByDayFnc(CWnd *pWnd){
	 return ((CFMDischargedPaidPatientListByDay*)pWnd)->OnSaveFMDischargedPaidPatientListByDay();
} 
static int _OnCancelFMDischargedPaidPatientListByDayFnc(CWnd *pWnd){
	 return ((CFMDischargedPaidPatientListByDay*)pWnd)->OnCancelFMDischargedPaidPatientListByDay();
}
/*
static int _OnObjectListCheckAllFnc(CWnd *pWnd){
	return ((CFMDischargedPaidPatientListByDay*)pWnd)->OnObjectListCheckAll();
}
static int _OnObjectListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMDischargedPaidPatientListByDay*)pWnd)->OnObjectListUnCheckAll();
}*/
static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CFMDischargedPaidPatientListByDay*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMDischargedPaidPatientListByDay*)pWnd)->OnDeptListUnCheckAll();
}

CFMDischargedPaidPatientListByDay::CFMDischargedPaidPatientListByDay(CWnd* pParent)
{
	m_nDlgWidth = 450;
	m_nDlgHeight = 555;
	SetDefaultValues();
}
CFMDischargedPaidPatientListByDay::~CFMDischargedPaidPatientListByDay(){
}
void CFMDischargedPaidPatientListByDay::OnCreateComponents()
{
...
void CFMDischargedPaidPatientListByDay::OnInitializeComponents()
{
...
void CFMDischargedPaidPatientListByDay::OnDoDataExchange(CDataExchange* pDX){
...
void CFMDischargedPaidPatientListByDay::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMDischargedPaidPatientListByDay::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMDischargedPaidPatientListByDay::SetDefaultValues(){
...
int CFMDischargedPaidPatientListByDay::SetMode(int nMode){
...
/*void CFMDischargedPaidPatientListByDay::OnYearChange(){
	
} */
/*void CFMDischargedPaidPatientListByDay::OnYearSetfocus(){
	
} */
/*void CFMDischargedPaidPatientListByDay::OnYearKillfocus(){
	
} */
int CFMDischargedPaidPatientListByDay::OnYearCheckValue()
{
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
...
void CFMDischargedPaidPatientListByDay::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMDischargedPaidPatientListByDay::OnReportPeriodSelendok()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMDischargedPaidPatientListByDay::OnReportPeriodSetfocus(){
	
}*/
/*void CFMDischargedPaidPatientListByDay::OnReportPeriodKillfocus(){
	
}*/
long CFMDischargedPaidPatientListByDay::OnReportPeriodLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMDischargedPaidPatientListByDay::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMDischargedPaidPatientListByDay::OnFromDateChange(){
	
} */
/*void CFMDischargedPaidPatientListByDay::OnFromDateSetfocus(){
	
} */
/*void CFMDischargedPaidPatientListByDay::OnFromDateKillfocus(){
	
} */
int CFMDischargedPaidPatientListByDay::OnFromDateCheckValue(){
	return 0;
} 
/*void CFMDischargedPaidPatientListByDay::OnToDateChange(){
	
} */
/*void CFMDischargedPaidPatientListByDay::OnToDateSetfocus(){
	
} */
/*void CFMDischargedPaidPatientListByDay::OnToDateKillfocus(){
	
} */
int CFMDischargedPaidPatientListByDay::OnToDateCheckValue(){
	return 0;
} 
void CFMDischargedPaidPatientListByDay::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMDischargedPaidPatientListByDay::OnClerkSelendok(){
	 
}
/*void CFMDischargedPaidPatientListByDay::OnClerkSetfocus(){
	
}*/
/*void CFMDischargedPaidPatientListByDay::OnClerkKillfocus(){
	
}*/
long CFMDischargedPaidPatientListByDay::OnClerkLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMDischargedPaidPatientListByDay::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMDischargedPaidPatientListByDay::OnStaffSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMDischargedPaidPatientListByDay::OnStaffSelendok(){
	 
}
/*void CFMDischargedPaidPatientListByDay::OnStaffSetfocus(){
	
}*/
/*void CFMDischargedPaidPatientListByDay::OnStaffKillfocus(){
	
}*/
long CFMDischargedPaidPatientListByDay::OnStaffLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMDischargedPaidPatientListByDay::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
...
void CFMDischargedPaidPatientListByDay::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
/*void CFMDischargedPaidPatientListByDay::OnObjectListDblClick(){
	
} 
void CFMDischargedPaidPatientListByDay::OnObjectListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMDischargedPaidPatientListByDay::OnObjectListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMDischargedPaidPatientListByDay::OnObjectListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMDischargedPaidPatientListByDay::OnDeptListDblClick(){
	
} 
void CFMDischargedPaidPatientListByDay::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMDischargedPaidPatientListByDay::OnDeptListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMDischargedPaidPatientListByDay::OnDeptListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
int CFMDischargedPaidPatientListByDay::OnAddFMDischargedPaidPatientListByDay(){
...
int CFMDischargedPaidPatientListByDay::OnSaveFMDischargedPaidPatientListByDay(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
 ...
 _fmsg(_T("%s"), szSQL);
 	...
 	if(ret > 0)
 	{
 		//OnFMDischargedPaidPatientListByDayListLoadData();
 		SetMode(VM_VIEW);
 	}
 	else
 	{
...
int CFMDischargedPaidPatientListByDay::OnCancelFMDischargedPaidPatientListByDay(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMDischargedPaidPatientListByDay::OnDeptListCheckAll()
{
...
int CFMDischargedPaidPatientListByDay::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
...
/*int CFMDischargedPaidPatientListByDay::OnObjectListCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
...
int CFMDischargedPaidPatientListByDay::OnObjectListUnCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (m_wndObjectList.GetCheck(i))
...
CString CFMDischargedPaidPatientListByDay::GetQueryString(){
	...
	/*szSQL.Format(_T("SELECT    Get_patientname(docno) pname, docno, ") \
				...
				_T("                             AND a.hfe_status IN ('P') AND dc.hd_object = '7') ") \
	...
	szSQL.Format(_T("SELECT    Get_patientname(docno) pname, docno, ") \
				...
				_T("                   LEFT JOIN hms_clinical_record ON ( hcr_docno = d.hfe_docno ) ") \
				_T("                   WHERE     1 = 1 ") \
				_T("                             AND hcr_status = 'T' AND d.hfe_status NOT IN ('C') ") \
				_T("                             AND a.hfe_status IN ('P', 'A') AND d.hfe_objectid = '7' %s) ") \
