#ifndef FMUNLOCKEDMONEYTAKERLIST_H
#define FMUNLOCKEDMONEYTAKERLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMUnlockedMoneytakerList : public CGuiView{
protected:
public:
	CGuiGroupBox	m_wndUnlockedMoneytakerList;
	...
	void			OnExcelSelect(); 
	CFMUnlockedMoneytakerList(CWnd *pParent);
	~CFMUnlockedMoneytakerList();
