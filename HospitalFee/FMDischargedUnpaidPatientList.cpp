#include "stdafx.h"
#include "FMDischargedUnpaidPatientList.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientList *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientList *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientList *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientList *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMDischargedUnpaidPatientList* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientList *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientList *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientList *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientList *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientList *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientList *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientList *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientList *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientList *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientList *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientList *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientList *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientList *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMDischargedUnpaidPatientList* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientList *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientList *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientList *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientList *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientList *)pWnd)->OnClerkAddNew();
}*/
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMDischargedUnpaidPatientList *pVw = (CFMDischargedUnpaidPatientList *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnObjectListLoadDataFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientList*)pWnd)->OnObjectListLoadData();
} 
static void _OnObjectListDblClickFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientList*)pWnd)->OnObjectListDblClick();
} 
static void _OnObjectListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMDischargedUnpaidPatientList*)pWnd)->OnObjectListSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMDischargedUnpaidPatientList*)pWnd)->OnObjectListDeleteItem();
} */
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientList*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CFMDischargedUnpaidPatientList*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMDischargedUnpaidPatientList*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMDischargedUnpaidPatientList*)pWnd)->OnDeptListDeleteItem();
} 
static int _OnAddFMDischargedUnpaidPatientListFnc(CWnd *pWnd){
	 return ((CFMDischargedUnpaidPatientList*)pWnd)->OnAddFMDischargedUnpaidPatientList();
} 
static int _OnEditFMDischargedUnpaidPatientListFnc(CWnd *pWnd){
	 return ((CFMDischargedUnpaidPatientList*)pWnd)->OnEditFMDischargedUnpaidPatientList();
} 
static int _OnDeleteFMDischargedUnpaidPatientListFnc(CWnd *pWnd){
	 return ((CFMDischargedUnpaidPatientList*)pWnd)->OnDeleteFMDischargedUnpaidPatientList();
} 
static int _OnSaveFMDischargedUnpaidPatientListFnc(CWnd *pWnd){
	 return ((CFMDischargedUnpaidPatientList*)pWnd)->OnSaveFMDischargedUnpaidPatientList();
} 
static int _OnCancelFMDischargedUnpaidPatientListFnc(CWnd *pWnd){
	 return ((CFMDischargedUnpaidPatientList*)pWnd)->OnCancelFMDischargedUnpaidPatientList();
}
/*
static int _OnObjectListCheckAllFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientList*)pWnd)->OnObjectListCheckAll();
}
static int _OnObjectListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientList*)pWnd)->OnObjectListUnCheckAll();
}*/
static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientList*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMDischargedUnpaidPatientList*)pWnd)->OnDeptListUnCheckAll();
}

CFMDischargedUnpaidPatientList::CFMDischargedUnpaidPatientList(CWnd* pParent)
{
	m_nDlgWidth = 450;
	m_nDlgHeight = 555;
	SetDefaultValues();
}
CFMDischargedUnpaidPatientList::~CFMDischargedUnpaidPatientList(){
}
void CFMDischargedUnpaidPatientList::OnCreateComponents()
{
...
void CFMDischargedUnpaidPatientList::OnInitializeComponents()
{
...
void CFMDischargedUnpaidPatientList::OnSetWindowEvents()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMDischargedUnpaidPatientList::OnDoDataExchange(CDataExchange* pDX){
...
void CFMDischargedUnpaidPatientList::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMDischargedUnpaidPatientList::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMDischargedUnpaidPatientList::SetDefaultValues(){
...
int CFMDischargedUnpaidPatientList::SetMode(int nMode){
...
/*void CFMDischargedUnpaidPatientList::OnYearChange(){
	
} */
/*void CFMDischargedUnpaidPatientList::OnYearSetfocus(){
	
} */
/*void CFMDischargedUnpaidPatientList::OnYearKillfocus(){
	
} */
int CFMDischargedUnpaidPatientList::OnYearCheckValue()
{
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
...
void CFMDischargedUnpaidPatientList::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMDischargedUnpaidPatientList::OnReportPeriodSelendok()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMDischargedUnpaidPatientList::OnReportPeriodSetfocus(){
	
}*/
/*void CFMDischargedUnpaidPatientList::OnReportPeriodKillfocus(){
	
}*/
long CFMDischargedUnpaidPatientList::OnReportPeriodLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMDischargedUnpaidPatientList::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMDischargedUnpaidPatientList::OnFromDateChange(){
	
} */
/*void CFMDischargedUnpaidPatientList::OnFromDateSetfocus(){
	
} */
/*void CFMDischargedUnpaidPatientList::OnFromDateKillfocus(){
	
} */
int CFMDischargedUnpaidPatientList::OnFromDateCheckValue(){
	return 0;
} 
/*void CFMDischargedUnpaidPatientList::OnToDateChange(){
	
} */
/*void CFMDischargedUnpaidPatientList::OnToDateSetfocus(){
	
} */
/*void CFMDischargedUnpaidPatientList::OnToDateKillfocus(){
	
} */
int CFMDischargedUnpaidPatientList::OnToDateCheckValue(){
	return 0;
} 
void CFMDischargedUnpaidPatientList::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMDischargedUnpaidPatientList::OnClerkSelendok(){
	 
}
/*void CFMDischargedUnpaidPatientList::OnClerkSetfocus(){
	
}*/
/*void CFMDischargedUnpaidPatientList::OnClerkKillfocus(){
	
}*/
long CFMDischargedUnpaidPatientList::OnClerkLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMDischargedUnpaidPatientList::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMDischargedUnpaidPatientList::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
...
void CFMDischargedUnpaidPatientList::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
/*void CFMDischargedUnpaidPatientList::OnObjectListDblClick(){
	
} 
void CFMDischargedUnpaidPatientList::OnObjectListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMDischargedUnpaidPatientList::OnObjectListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMDischargedUnpaidPatientList::OnObjectListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMDischargedUnpaidPatientList::OnDeptListDblClick(){
	
} 
void CFMDischargedUnpaidPatientList::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMDischargedUnpaidPatientList::OnDeptListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMDischargedUnpaidPatientList::OnDeptListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
int CFMDischargedUnpaidPatientList::OnAddFMDischargedUnpaidPatientList(){
...
int CFMDischargedUnpaidPatientList::OnEditFMDischargedUnpaidPatientList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMDischargedUnpaidPatientList::OnDeleteFMDischargedUnpaidPatientList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelFMDischargedUnpaidPatientList();
 	}
	return 0;
}
int CFMDischargedUnpaidPatientList::OnSaveFMDischargedUnpaidPatientList(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
 ...
 _fmsg(_T("%s"), szSQL);
 	...
 	if(ret > 0)
 	{
 		//OnFMDischargedUnpaidPatientListListLoadData();
 		SetMode(VM_VIEW);
 	}
 	else
 	{
...
int CFMDischargedUnpaidPatientList::OnCancelFMDischargedUnpaidPatientList(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMDischargedUnpaidPatientList::OnDeptListCheckAll()
{
...
int CFMDischargedUnpaidPatientList::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
...
/*int CFMDischargedUnpaidPatientList::OnObjectListCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
...
int CFMDischargedUnpaidPatientList::OnObjectListUnCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (m_wndObjectList.GetCheck(i))
...
CString CFMDischargedUnpaidPatientList::GetQueryString(){
