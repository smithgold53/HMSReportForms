#include "stdafx.h"
#include "FMTempSendNoOutPatientListByDay.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMTempSendNoOutPatientListByDay *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMTempSendNoOutPatientListByDay *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMTempSendNoOutPatientListByDay *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMTempSendNoOutPatientListByDay *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMTempSendNoOutPatientListByDay* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMTempSendNoOutPatientListByDay *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMTempSendNoOutPatientListByDay *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMTempSendNoOutPatientListByDay *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMTempSendNoOutPatientListByDay *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMTempSendNoOutPatientListByDay *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMTempSendNoOutPatientListByDay *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMTempSendNoOutPatientListByDay *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMTempSendNoOutPatientListByDay *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMTempSendNoOutPatientListByDay *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMTempSendNoOutPatientListByDay *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMTempSendNoOutPatientListByDay *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMTempSendNoOutPatientListByDay *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMTempSendNoOutPatientListByDay *)pWnd)->OnToDateCheckValue();
} 
static void _OnStaffSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMTempSendNoOutPatientListByDay* )pWnd)->OnStaffSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStaffSelendokFnc(CWnd *pWnd){
	((CFMTempSendNoOutPatientListByDay *)pWnd)->OnStaffSelendok();
}
/*static void _OnStaffSetfocusFnc(CWnd *pWnd){
	((CFMTempSendNoOutPatientListByDay *)pWnd)->OnStaffKillfocus();
}*/
/*static void _OnStaffKillfocusFnc(CWnd *pWnd){
	((CFMTempSendNoOutPatientListByDay *)pWnd)->OnStaffKillfocus();
}*/
static long _OnStaffLoadDataFnc(CWnd *pWnd){
	return ((CFMTempSendNoOutPatientListByDay *)pWnd)->OnStaffLoadData();
}
/*static void _OnStaffAddNewFnc(CWnd *pWnd){
	((CFMTempSendNoOutPatientListByDay *)pWnd)->OnStaffAddNew();
}*/
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMTempSendNoOutPatientListByDay *pVw = (CFMTempSendNoOutPatientListByDay *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CFMTempSendNoOutPatientListByDay*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CFMTempSendNoOutPatientListByDay*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMTempSendNoOutPatientListByDay*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMTempSendNoOutPatientListByDay*)pWnd)->OnDeptListDeleteItem();
} 
static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CFMTempSendNoOutPatientListByDay*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMTempSendNoOutPatientListByDay*)pWnd)->OnDeptListUnCheckAll();
}
CFMTempSendNoOutPatientListByDay::CFMTempSendNoOutPatientListByDay(CWnd *pParent){

	m_nDlgWidth = 585;
	m_nDlgHeight = 585;
	SetDefaultValues();
}
CFMTempSendNoOutPatientListByDay::~CFMTempSendNoOutPatientListByDay(){
}
void CFMTempSendNoOutPatientListByDay::OnCreateComponents(){
...
void CFMTempSendNoOutPatientListByDay::OnInitializeComponents(){
...
void CFMTempSendNoOutPatientListByDay::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMTempSendNoOutPatientListByDay::OnDoDataExchange(CDataExchange* pDX){
...
void CFMTempSendNoOutPatientListByDay::SetDefaultValues(){
...
int CFMTempSendNoOutPatientListByDay::SetMode(int nMode){
...
/*void CFMTempSendNoOutPatientListByDay::OnYearChange(){
	
} */
/*void CFMTempSendNoOutPatientListByDay::OnYearSetfocus(){
	
} */
/*void CFMTempSendNoOutPatientListByDay::OnYearKillfocus(){
	
} */
int CFMTempSendNoOutPatientListByDay::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMTempSendNoOutPatientListByDay::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMTempSendNoOutPatientListByDay::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMTempSendNoOutPatientListByDay::OnReportPeriodSetfocus(){
	
}*/
/*void CFMTempSendNoOutPatientListByDay::OnReportPeriodKillfocus(){
	
}*/
long CFMTempSendNoOutPatientListByDay::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMTempSendNoOutPatientListByDay::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMTempSendNoOutPatientListByDay::OnFromDateChange(){
	
} */
/*void CFMTempSendNoOutPatientListByDay::OnFromDateSetfocus(){
	
} */
/*void CFMTempSendNoOutPatientListByDay::OnFromDateKillfocus(){
	
} */
int CFMTempSendNoOutPatientListByDay::OnFromDateCheckValue(){
	return 0;
}
 
/*void CFMTempSendNoOutPatientListByDay::OnToDateChange(){
	
} */
/*void CFMTempSendNoOutPatientListByDay::OnToDateSetfocus(){
	
} */
/*void CFMTempSendNoOutPatientListByDay::OnToDateKillfocus(){
	
} */
int CFMTempSendNoOutPatientListByDay::OnToDateCheckValue(){
	return 0;
}
 void CFMTempSendNoOutPatientListByDay::OnStaffSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMTempSendNoOutPatientListByDay::OnStaffSelendok(){
	 
}
/*void CFMTempSendNoOutPatientListByDay::OnStaffSetfocus(){
	
}*/
/*void CFMTempSendNoOutPatientListByDay::OnStaffKillfocus(){
	
}*/
long CFMTempSendNoOutPatientListByDay::OnStaffLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	...
	int nCount = 0;
	szSQL.Format(_T("SELECT su_userid as userid, su_name as username FROM sys_user WHERE 1=1 %s ORDER BY userid "), szWhere);
	nCount = rs.ExecSQL(szSQL);
	while(!rs.IsEOF()){ 
		m_wndStaff.AddItems(
...
/*void CFMTempSendNoOutPatientListByDay::OnStaffAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMTempSendNoOutPatientListByDay::OnPrintSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMTempSendNoOutPatientListByDay::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMTempSendNoOutPatientListByDay::OnDeptListDblClick(){
	
}
 
void CFMTempSendNoOutPatientListByDay::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMTempSendNoOutPatientListByDay::OnDeptListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMTempSendNoOutPatientListByDay::OnDeptListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
CString CFMTempSendNoOutPatientListByDay::GetQueryString(){
	...
	szSQL.Format(_T(" SELECT    Get_patientname(hfe_docno)     pname, ") \
				...
				_T("       AND hfe_status = 'P' AND hfe_objectid = '7' AND fac_posted = 'Y' AND hcr_status <> 'T'") \
				_T(" ORDER     BY fac_posteddate "), m_szFromDate, m_szToDate, szWhere);

	return szSQL;
}

int CFMTempSendNoOutPatientListByDay::OnDeptListCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (!m_wndDeptList.GetCheck(i))
...
int CFMTempSendNoOutPatientListByDay::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
