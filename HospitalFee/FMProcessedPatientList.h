#ifndef FMPROCESSEDPATIENTLIST_H
#define FMPROCESSEDPATIENTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMProcessedPatientList : public CGuiView{
protected:
public:
	...
	CFMProcessedPatientList(CWnd *pParent);
	~CFMProcessedPatientList();
