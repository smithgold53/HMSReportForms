#ifndef FMUNDISCHARGEDADVANCEPATIENTLIST_H
#define FMUNDISCHARGEDADVANCEPATIENTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMUndischargedAdvancePatientList : public CGuiView{
protected:
public:
	...
	CFMUndischargedAdvancePatientList(CWnd *pParent);
	~CFMUndischargedAdvancePatientList();
	...
	void OnExportFormat1();
	void OnExportFormat2();
};
#endif
