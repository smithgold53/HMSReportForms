#ifndef FMSERVICEINCOMELIST_H
#define FMSERVICEINCOMELIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMServiceIncomeList : public CGuiView{
protected:
public:
	...
	CGuiLabel		m_wndReceiptListLabel;
	CGuiComboBox	m_wndReceiptList;
	CGuiCheckBox	m_wndReportByReceipt;
	...
	CString	m_szReceiptListKey;
	BOOL	m_bLocked;
	BOOL	m_bApproval;
	BOOL	m_bReportbyReceipt;
	//void			OnYearChange(); 
	//void			OnYearSetfocus(); 
	...
	long		OnReceiptListLoadData();
	void			OnReportByReceiptSelect();
	void			OnPrintSelect(); 
	void			OnExportSelect(); 
	...
	void			OnLockedSelect(); 
	CFMServiceIncomeList(CWnd *pParent);
	~CFMServiceIncomeList();
