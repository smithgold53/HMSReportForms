#ifndef TMTotalPatientListDischarge_H
#define TMTotalPatientListDischarge_H
...
#include "GuiView.h"
#include "DbField.h"
class CTMTotalPatientListDischarge : public CGuiView{
protected:
public:
	...
	CTMTotalPatientListDischarge(CWnd *pWnd);
	~CTMTotalPatientListDischarge();
