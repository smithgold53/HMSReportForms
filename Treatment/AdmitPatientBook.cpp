...
void CAdmitPatientBook::OnExportSelect(){
	...
	xls.SetCellText(0, 3, _T("S\x1ED4 V\xC0O VI\x1EC6N"), FMT_TEXT | FMT_CENTER | FMT_WRAPING, true, 12);
	...
	xls.SetCellText(12, 6, _T("\x43h\x1EA9n \x111o\xE1n K\x42"), FMT_TEXT | FMT_CENTER | FMT_WRAPING, true, 11);
	xls.SetCellText(13, 6, _T("\x43h\x1EA9n \x111o\xE1n K\xD0T"), FMT_TEXT | FMT_CENTER | FMT_WRAPING, true, 11);
	xls.SetCellText(14, 6, _T("Ghi \x63h\xFA"), FMT_TEXT | FMT_CENTER | FMT_WRAPING, true, 11);
...
CString CAdmitPatientBook::GetQueryString()
{
	...
	szWhere.AppendFormat(_T(" AND htr_status<> 'A' AND htr_admitdate BETWEEN cast_string2timestamp('%s') AND cast_string2timestamp('%s')"), m_szFromDate, m_szToDate);
