#ifndef TMDEPARTMENTUSAGEINDETAIL_H
#define TMDEPARTMENTUSAGEINDETAIL_H
...
#include "GuiView.h"
#include "DbField.h"
class CTMDepartmentUsageinDetail : public CGuiView{
protected:
	BOOL	m_bStockCheck;
	BOOL	m_bDeptCheck;
public:
	...
	void			OnExportSelect(); 
	CTMDepartmentUsageinDetail(CWnd *pParent);
	~CTMDepartmentUsageinDetail();
