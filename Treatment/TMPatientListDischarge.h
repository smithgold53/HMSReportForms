#ifndef TMPatientListDischarge_H
#define TMPatientListDischarge_H
...
#include "GuiView.h"
#include "DbField.h"
class CTMPatientListDischarge : public CGuiView{
protected:
public:
	...
	CTMPatientListDischarge(CWnd *pWnd);
	~CTMPatientListDischarge();
