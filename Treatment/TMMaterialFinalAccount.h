#ifndef TMMATERIALFINALACCOUNT_H
#define TMMATERIALFINALACCOUNT_H
...
#include "GuiView.h"
#include "DbField.h"
class CTMMaterialFinalAccount : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CTMMaterialFinalAccount(CWnd *pParent);
	~CTMMaterialFinalAccount();
