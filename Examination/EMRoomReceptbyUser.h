#ifndef EMROOMRECEPTBYUSER_H
#define EMROOMRECEPTBYUSER_H
...
#include "GuiView.h"
#include "DbField.h"
class CEMRoomReceptbyUser : public CGuiView{
protected:
	CString	m_szUser;
public:
	CGuiGroupBox	m_wndRoomReceptbyUser;
	...
	CEMRoomReceptbyUser(CWnd *pParent);
	~CEMRoomReceptbyUser();
	...
	void OnUserListCheckAll();
	void OnUserListUncheckAll();
	void OnRoomListCheckAll();
	void OnRoomListUncheckAll();
};
#endif
