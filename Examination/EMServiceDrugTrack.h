#ifndef EMSERVICEDRUGTRACK_H
#define EMSERVICEDRUGTRACK_H
...
#include "GuiView.h"
#include "DbField.h"
class CEMServiceDrugTrack : public CGuiView{
protected:
public:
	CGuiGroupBox	m_wndServiceDrugTrack;
	...
	void			OnPrintSelect(); 
	void			OnExportSelect(); 
	CEMServiceDrugTrack(CWnd *pParent);
	~CEMServiceDrugTrack();
