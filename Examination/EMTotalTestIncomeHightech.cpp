#include "stdafx.h"
#include "EMTotalTestIncomeHightech.h"
#include "HMSMainFrame.h"
#include "Excel.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CEMTotalTestIncomeHightech *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CEMTotalTestIncomeHightech* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CEMTotalTestIncomeHightech *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CEMTotalTestIncomeHightech *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CEMTotalTestIncomeHightech *)pWnd)->OnToDateCheckValue();
} 
static void _OnRoomSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CEMTotalTestIncomeHightech* )pWnd)->OnRoomSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnRoomSelendokFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnRoomSelendok();
}
/*static void _OnRoomSetfocusFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnRoomKillfocus();
}*/
/*static void _OnRoomKillfocusFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnRoomKillfocus();
}*/
static long _OnRoomLoadDataFnc(CWnd *pWnd){
	return ((CEMTotalTestIncomeHightech *)pWnd)->OnRoomLoadData();
}
/*static void _OnRoomAddNewFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnRoomAddNew();
}*/
static void _OnDoctorSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CEMTotalTestIncomeHightech* )pWnd)->OnDoctorSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDoctorSelendokFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnDoctorSelendok();
}
/*static void _OnDoctorSetfocusFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnDoctorKillfocus();
}*/
/*static void _OnDoctorKillfocusFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnDoctorKillfocus();
}*/
static long _OnDoctorLoadDataFnc(CWnd *pWnd){
	return ((CEMTotalTestIncomeHightech *)pWnd)->OnDoctorLoadData();
}
/*static void _OnDoctorAddNewFnc(CWnd *pWnd){
	((CEMTotalTestIncomeHightech *)pWnd)->OnDoctorAddNew();
}*/
static void _OnExportSelectFnc(CWnd *pWnd){
	/*((CEMTotalTestIncomeHightech *)pVw) = (CEMTotalTestIncomeHightech *)pWnd;
	pVw->OnExportSelect();*/
	((CEMTotalTestIncomeHightech *)pWnd)->OnExportSelect();
} 
CEMTotalTestIncomeHightech::CEMTotalTestIncomeHightech(CWnd *pWnd){

	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
	SetDefaultValues();
}
CEMTotalTestIncomeHightech::~CEMTotalTestIncomeHightech(){
}
void CEMTotalTestIncomeHightech::OnCreateComponents(){
...
void CEMTotalTestIncomeHightech::OnInitializeComponents(){
...
void CEMTotalTestIncomeHightech::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CEMTotalTestIncomeHightech::OnDoDataExchange(CDataExchange* pDX){
...
void CEMTotalTestIncomeHightech::SetDefaultValues(){
...
int CEMTotalTestIncomeHightech::SetMode(int nMode){
...
/*void CEMTotalTestIncomeHightech::OnYearChange(){
	
} */
/*void CEMTotalTestIncomeHightech::OnYearSetfocus(){
	
} */
/*void CEMTotalTestIncomeHightech::OnYearKillfocus(){
	
} */
int CEMTotalTestIncomeHightech::OnYearCheckValue(){
	return 0;
} 
void CEMTotalTestIncomeHightech::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CEMTotalTestIncomeHightech::OnReportPeriodSelendok(){
	CString tmpStr;
	CDate dte;
	UpdateData(true);
...
/*void CEMTotalTestIncomeHightech::OnReportPeriodSetfocus(){
	
}*/
/*void CEMTotalTestIncomeHightech::OnReportPeriodKillfocus(){
	
}*/
long CEMTotalTestIncomeHightech::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
		CRecord rs(&pMF->m_db);
...
/*void CEMTotalTestIncomeHightech::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CEMTotalTestIncomeHightech::OnFromDateChange(){
	
} */
/*void CEMTotalTestIncomeHightech::OnFromDateSetfocus(){
	
} */
/*void CEMTotalTestIncomeHightech::OnFromDateKillfocus(){
	
} */
int CEMTotalTestIncomeHightech::OnFromDateCheckValue(){
	return 0;
} 
/*void CEMTotalTestIncomeHightech::OnToDateChange(){
	
} */
/*void CEMTotalTestIncomeHightech::OnToDateSetfocus(){
	
} */
/*void CEMTotalTestIncomeHightech::OnToDateKillfocus(){
	
} */
int CEMTotalTestIncomeHightech::OnToDateCheckValue(){
	return 0;
} 
void CEMTotalTestIncomeHightech::OnRoomSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CEMTotalTestIncomeHightech::OnRoomSelendok(){
	 
}
/*void CEMTotalTestIncomeHightech::OnRoomSetfocus(){
	
}*/
/*void CEMTotalTestIncomeHightech::OnRoomKillfocus(){
	
}*/
long CEMTotalTestIncomeHightech::OnRoomLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CEMTotalTestIncomeHightech::OnRoomAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CEMTotalTestIncomeHightech::OnDoctorSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CEMTotalTestIncomeHightech::OnDoctorSelendok(){
	 
}
/*void CEMTotalTestIncomeHightech::OnDoctorSetfocus(){
	
}*/
/*void CEMTotalTestIncomeHightech::OnDoctorKillfocus(){
	
}*/
long CEMTotalTestIncomeHightech::OnDoctorLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CEMTotalTestIncomeHightech::OnDoctorAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */

void CEMTotalTestIncomeHightech::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CExcel xls;
	...
	xls.SetCellText(0, 2, _T("T\x1ED5ng ti\x1EC1n \x78\xE9t nghi\x1EC7m k\xE8m k\x1EF9 thu\x1EADt \x63\x61o"), 4098, true);
	...
	xls.SetCellText(4, 4, _T("\x44\x1ECB\x63h v\x1EE5"), 4098, true);
	xls.SetCellText(4, 5, _T("S\x1ED1 \x42N"), 4098);
	xls.SetCellText(5, 5, _T("S\x1ED1 ti\x1EC1n"), 4098);
	//xls.SetCellText(7, 5, _T("TB/BN"), 4098);
	xls.SetCellMergedColumns(6, 4, 2);
	xls.SetCellText(6, 4, _T("BH \x63huy\x1EC3n+tr\xE1i tuy\x1EBFn"), 4098, true);
	xls.SetCellText(6, 5, _T("S\x1ED1 \x42N"), 4098);
	xls.SetCellText(7, 5, _T("S\x1ED1 ti\x1EC1n"), 4098);
	//xls.SetCellText(10, 5, _T("TB/BN"), 4098);
	xls.SetCellMergedColumns(8, 4, 2);
	...
	xls.SetCellMergedColumns(10, 4, 2);
	xls.SetCellText(10, 4, _T("Qu\xE2n"), 4098, true);
	xls.SetCellText(10, 5, _T("S\x1ED1 \x42N"), 4098);
	xls.SetCellText(11, 5, _T("S\x1ED1 ti\x1EC1n"), 4098);
	//xls.SetCellText(16, 5, _T("TB/BN"), 4098);
	xls.SetCellMergedColumns(12, 4, 2);
	xls.SetCellText(12, 4, _T("Kh\xE1\x63"), 4098, true);
	xls.SetCellText(12, 5, _T("S\x1ED1 \x42N"), 4098);
	xls.SetCellText(13, 5, _T("S\x1ED1 ti\x1EC1n"), 4098);
	...
	xls.Save(_T("Exports\\Tong hop tien xet nghiem kem theo KTC.xls"));
} 

CString CEMTotalTestIncomeHightech::GetQueryString(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL, szWhere, szWhere1;
	szWhere.Format(_T(" AND hpc_deptid = '%s' AND hpc_orderdate BETWEEN cast_string2timestamp('%s') AND cast_string2timestamp('%s')")
					, pMF->GetCurrentDepartmentID(), m_szFromDate, m_szToDate);
	szWhere1.Format(_T(" AND he_deptid = '%s' AND he_examdate BETWEEN cast_string2timestamp('%s') AND cast_string2timestamp('%s')")
					, pMF->GetCurrentDepartmentID(), m_szFromDate, m_szToDate);
