#include "stdafx.h"
#include "EMMonthlyDrugIncome.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CEMMonthlyDrugIncome *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CEMMonthlyDrugIncome *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CEMMonthlyDrugIncome *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CEMMonthlyDrugIncome *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CEMMonthlyDrugIncome* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CEMMonthlyDrugIncome *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CEMMonthlyDrugIncome *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CEMMonthlyDrugIncome *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CEMMonthlyDrugIncome *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CEMMonthlyDrugIncome *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CEMMonthlyDrugIncome *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CEMMonthlyDrugIncome *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CEMMonthlyDrugIncome *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CEMMonthlyDrugIncome *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CEMMonthlyDrugIncome *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CEMMonthlyDrugIncome *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CEMMonthlyDrugIncome *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CEMMonthlyDrugIncome *)pWnd)->OnToDateCheckValue();
} 
static void _OnPrintSelectFnc(CWnd *pWnd){
	CEMMonthlyDrugIncome *pVw = (CEMMonthlyDrugIncome *)pWnd;
	pVw->OnPrintSelect();
} 
...
static int _OnAddEMStatisticsGeneralPatientReportFnc(CWnd *pWnd){
	 return ((CEMMonthlyDrugIncome*)pWnd)->OnAddEMStatisticsGeneralPatientReport();
} 
static int _OnEditEMStatisticsGeneralPatientReportFnc(CWnd *pWnd){
	 return ((CEMMonthlyDrugIncome*)pWnd)->OnEditEMStatisticsGeneralPatientReport();
} 
static int _OnDeleteEMStatisticsGeneralPatientReportFnc(CWnd *pWnd){
	 return ((CEMMonthlyDrugIncome*)pWnd)->OnDeleteEMStatisticsGeneralPatientReport();
} 
static int _OnSaveEMStatisticsGeneralPatientReportFnc(CWnd *pWnd){
	 return ((CEMMonthlyDrugIncome*)pWnd)->OnSaveEMStatisticsGeneralPatientReport();
} 
static int _OnCancelEMStatisticsGeneralPatientReportFnc(CWnd *pWnd){
	 return ((CEMMonthlyDrugIncome*)pWnd)->OnCancelEMStatisticsGeneralPatientReport();
} 
...
CEMMonthlyDrugIncome::~CEMMonthlyDrugIncome()
{
}
void CEMMonthlyDrugIncome::OnCreateComponents(){
...
void CEMMonthlyDrugIncome::OnInitializeComponents(){
...
void CEMMonthlyDrugIncome::OnSetWindowEvents(){
...
void CEMMonthlyDrugIncome::OnDoDataExchange(CDataExchange* pDX){
	DDX_Text(pDX, m_wndYear.GetDlgCtrlID(), m_nYear);
	DDX_TextEx(pDX, m_wndReportPeriod.GetDlgCtrlID(), m_szReportPeriodKey);
	DDX_TextEx(pDX, m_wndFromDate.GetDlgCtrlID(), m_szFromDate);
	DDX_TextEx(pDX, m_wndToDate.GetDlgCtrlID(), m_szToDate);
}
void CEMMonthlyDrugIncome::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CEMMonthlyDrugIncome::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CEMMonthlyDrugIncome::SetDefaultValues(){
...
int CEMMonthlyDrugIncome::SetMode(int nMode){
...
/*void CEMMonthlyDrugIncome::OnYearChange(){
	
} */
/*void CEMMonthlyDrugIncome::OnYearSetfocus(){
	
} */
/*void CEMMonthlyDrugIncome::OnYearKillfocus(){
	
} */
int CEMMonthlyDrugIncome::OnYearCheckValue(){
	return 0;
} 
void CEMMonthlyDrugIncome::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CEMMonthlyDrugIncome::OnReportPeriodSelendok(){
	CString tmpStr;
	CDate dte;
	UpdateData(true);
...
/*void CEMMonthlyDrugIncome::OnReportPeriodSetfocus(){
	
}*/
/*void CEMMonthlyDrugIncome::OnReportPeriodKillfocus(){
	
}*/
long CEMMonthlyDrugIncome::OnReportPeriodLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
		CRecord rs(&pMF->m_db);
...
/*void CEMMonthlyDrugIncome::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CEMMonthlyDrugIncome::OnFromDateChange(){
	
} */
/*void CEMMonthlyDrugIncome::OnFromDateSetfocus(){
	
} */
/*void CEMMonthlyDrugIncome::OnFromDateKillfocus(){
	
} */
int CEMMonthlyDrugIncome::OnFromDateCheckValue(){
	return 0;
} 
/*void CEMMonthlyDrugIncome::OnToDateChange(){
	
} */
/*void CEMMonthlyDrugIncome::OnToDateSetfocus(){
	
} */
/*void CEMMonthlyDrugIncome::OnToDateKillfocus(){
	
} */
int CEMMonthlyDrugIncome::OnToDateCheckValue(){
	return 0;
} 
...
void CEMMonthlyDrugIncome::OnCloseSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CEMMonthlyDrugIncome::OnAddEMStatisticsGeneralPatientReport(){
...
int CEMMonthlyDrugIncome::OnEditEMStatisticsGeneralPatientReport(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CEMMonthlyDrugIncome::OnDeleteEMStatisticsGeneralPatientReport(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CEMMonthlyDrugIncome::OnSaveEMStatisticsGeneralPatientReport(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CEMMonthlyDrugIncome::OnCancelEMStatisticsGeneralPatientReport(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CEMMonthlyDrugIncome::OnEMStatisticsGeneralPatientReportListLoadData()
{
	return 0;
}
CString CEMMonthlyDrugIncome::GetQueryString()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*)AfxGetMainWnd();
	CString szSQL, szWhere;
	szWhere.Format(_T(" AND he_deptid = '%s'"), pMF->GetCurrentDepartmentID());
	szWhere.AppendFormat(_T(" AND he_examdate BETWEEN cast_string2timestamp('%s') AND cast_string2timestamp('%s')"), m_szFromDate, m_szToDate);
	szSQL.Format(_T(" SELECT hrl_id, hrl_name as roomname,") \
				_T("   Sum(cnt)           AS examed,") \
				_T("   sum(drugpurchase) as drugpurchase,") \
				_T("   sum(hfe_amount) as amt,") \
				_T("   case when sum(drugpurchase) > 0 then sum(hfe_amount)/sum(drugpurchase) else 0 end as rate") \
				_T(" FROM   (SELECT") \
				...
				_T(" LEFT JOIN hms_roomlist ON (hrl_deptid = '%s' AND hrl_id = roomid)") \
